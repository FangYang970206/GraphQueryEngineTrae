...
oC_Using : USING SP oC_UsingItem ( SP? ',' SP? oC_UsingItem )* ;

oC_UsingItem : oC_Snapshot
             ;

oC_Snapshot : SNAPSHOT SP? '(' SP? StringLiteral SP? ',' SP? oC_Expression SP? ')' SP ON SP? '[' SP? oC_LabelName ( SP? ',' SP? oC_LabelName )* SP? ']' ;

SNAPSHOT : ( 'S' | 's' ) ( 'N' | 'n' ) ( 'A' | 'a' ) ( 'P' | 'p' ) ( 'S' | 's' ) ( 'H' | 'h' ) ( 'O' | 'o' ) ( 'T' | 't' ) ;

oC_Project : PROJECT SP BY SP oC_ProjectionItems ;

PROJECT : ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'J' | 'j' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'T' | 't' ) ;

oC_ProjectionItems : '{' SP? oC_ProjectionItem ( SP? ',' SP? oC_ProjectionItem )* SP? '}' ;

oC_ProjectionItem : oC_LabelName SP? ':' SP? '[' SP? ( oC_PropertyKeyName ( SP? ',' SP? oC_PropertyKeyName )* )? SP? ']' ;

EXPLAIN : ( 'E' | 'e' ) ( 'X' | 'x' ) ( 'P' | 'p' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ;

PROFILE : ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ;

oC_Query : oC_UsingClause? SP? oC_RegularQuery ( SP? oC_Project )? ;
