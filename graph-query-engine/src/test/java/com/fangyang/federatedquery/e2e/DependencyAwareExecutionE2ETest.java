...
class DependencyAwareExecutionE2ETest {
    ...
    private MetadataRegistrar metadataRegistrar;
    ...
    @BeforeEach
    void setUp() {
        metadataRegistrar = MetadataFactory.createRegistrar();
    ...
    class Scenario2_MixedEdgeTests {
        ...
        void setUpMixedEdge() {
            ...
            metadataRegistrar.registerLabel(elementLabel);
        }
    ...
    class EdgeCaseTests {
        ...
        void complexPath_ThreeHopsWithVirtualEdge() throws Exception {
            ...
            metadataRegistrar.registerLabel(portLabel);
