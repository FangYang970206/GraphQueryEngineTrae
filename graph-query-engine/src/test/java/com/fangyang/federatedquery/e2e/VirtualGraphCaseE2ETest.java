...
import com.fangyang.datasource.DataSourceFactory;
...
import com.fangyang.federatedquery.mockserver.MockHttpServer;
...
class VirtualGraphCaseE2ETest {
    ...
    void setUp() {
        ...
        DataSourceAdapter tugraphAdapter = DataSourceFactory.createTuGraphAdapter(connector, "tugraph");
